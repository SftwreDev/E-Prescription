...
import { Card, Button, Row, Col, CardGroup, Form, Badge , Table, Accordion} from 'react-bootstrap';
...
class PrescriptionDetail extends Component {
    ...
    componentDidMount(){
        ...
        PrescriptionService.getPatientInfo().then((res) => {
            ...
            <div style={{padding: "2rem"}}>
                <Card>
                    ...
                    <Card.Body>
                    {
                        ...
                        <Row>
                            <Col sm md lg="7">
                                <Card.Title>{patient.l_name}, {patient.f_name}</Card.Title>
                                <Card.Text>
                                <CardGroup>
                        ...
                        <Table striped bordered hover size="sm" className="text-center" style={{fontSize: "12px"}}> 
                            ...
                            <tbody>
                            {
                                this.state.prescription.map(
                                    ...
                                    <td><Badge variant="primary">{prescription.active.toString()}</Badge></td>
                                    <td>
                                        <div style={{display: "inline"}}>
                                            <Button variant="primary" size="sm" href="#None" style={{fontSize: "11px"}}>
                                            <FontAwesomeIcon icon={faPen} /> {''}
                                            ...
                                            <Button variant="danger" size="sm" onClick={() => this.setState({ active: this.setState.active = true })} className="text-white" style={{fontSize: "11px"}}>
